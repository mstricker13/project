...
cif = read.csv('C:/Users/Marco/PycharmProjects/DFKI/project/hiwi/deepEx/DeepEX-master/nn5_no_meta_mirror.csv', header = FALSE) #-----change
y=cif
#number of columns which contain meta information and should be ignored
ignore_col = 0 #3 for cif, 6 for m3 -----change
...
for (i in 1:rows) {
  ...
  horizon = 56#y[1,3] #-----change
  window_size = 70#horizon + 1
...
write.csv(final_comb,"C:/Users/Marco/PycharmProjects/DFKI/project/hiwi/deepEx/DeepEX-master/theta_0_hT_nn5_7.csv") #need to add path -----change
