...
cif = read.csv('C:/Users/Marco/PycharmProjects/DFKI/hiwi/deepEx/DeepEX-master/M3C_monthly.csv', header = FALSE) #-----change
y=cif
...
write.csv(final_comb,"C:/Users/Marco/PycharmProjects/DFKI/hiwi/deepEx/DeepEX-master/theta_50_hT_m3m7.csv") #need to add path -----change
