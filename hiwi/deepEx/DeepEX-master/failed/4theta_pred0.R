...
cif = read.csv('C:/Users/Marco/PycharmProjects/DFKI/hiwi/deepEx/DeepEX-master/M3C_yearly.csv', header = FALSE) #-----change
y=cif
...
for (i in 1:rows) {
  ...
  data = data[,1:length]
  d_l = dim(data)[2]
  s_l =as.integer(horizon)#d_l*per)???? Ask questions
...
write.csv(final_comb,"C:/Users/Marco/PycharmProjects/DFKI/hiwi/deepEx/DeepEX-master/theta_25_hT_m3y12.csv") #need to add path -----change
