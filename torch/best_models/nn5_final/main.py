...
def main():
    ...
    all_flag = True  # predict all at once
    # Define hyperparameters
    cif_path = os.path.join('data', 'nn5_conv.csv')
    theta_path = os.path.join('data', 'nn5_theta_25_horg.csv')
